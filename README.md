...
- [Y] Users are able to see at least 3 context items
- [Y] Users are able to tap into each context item and see detail view contains information about each item (title, description, picture if applicable, etc.)
 
The following **optional** features are implemented:

- [Y] Improve and customize the user interface through styling and coloring
...
I found constraints really difficult to understand and use
